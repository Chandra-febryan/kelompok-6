...
<div class="relative group pb-2">
    ...
    <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-xl z-20 hidden group-hover:block">
        ...
        <a href="admin_dashboard.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-green-100 hover:text-green-700 transition duration-150 ease-in-out">Edit Data</a>
        <a href="add_layanan.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-green-100 hover:text-green-700 transition duration-150 ease-in-out">Tambah Rute</a>
    </div>

</div> 
                <?php endif; ?>
                <a href="logout.php" class="bg-red-500 hover:bg-red-600 px-3 py-1 rounded text-white transition duration-150 ease-in-out font-medium">Logout</a>
            <?php else: ?>
                <div class="relative group pb-2">
